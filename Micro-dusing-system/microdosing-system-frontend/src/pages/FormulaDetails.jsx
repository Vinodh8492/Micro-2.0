...
const FormulaDetails = () => {
  ...
  const handleSetPointChange = (recipeId, value) => {
    ...
    console.log(`SetPoint Updated — Recipe ID: ${recipeId}, New Value: ${value}`);
    console.log("Current SetPoints:", updated);
  };
  ...
  const handleActualChange = (recipeId, value) => {
    ...
    console.log(`Actual Updated — Recipe ID: ${recipeId}, New Value: ${value}`);
    console.log("Current ActualValues:", updated);
  };
                ...
                >
                    ...
                    <FormControl fullWidth>
                      ...
                      >
                        {materials.map((material) => (
                          <MenuItem key={material.material_id} value={material.description}>
                  ...
                  <td className="p-3 border">
                    <input
                      ...
                      value={setPoints[mat.recipe_id] ?? mat.setPoint}
                      onChange={(e) => handleSetPointChange(mat.recipe_id, e.target.value)}
                      placeholder={`SetPoint Values`}
                    />
